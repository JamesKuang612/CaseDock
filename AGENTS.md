...
- Test cases are versioned YAML. Final run records and reviewed evidence may be tracked by Git; temporary inbox data stays under ignored `.casedock/`. Never commit credentials or sensitive evidence.
